...
**Файлы:**
- `bot/keyboards/settings.py` — клавиатуры для настроек (лимит, тихие часы, задержки + возврат)
- `bot/states/settings.py` — SettingsEditState (editing_quiet_hours, editing_delays)
- `bot/handlers/settings.py`:
  - Показ текущих настроек (лимит, тихие часы, задержки)
  - Изменение лимита рассылки (inline-кнопки: 3, 5, 10, 15)
  - Изменение тихих часов (ввод текстом «23:00-08:00»)
  - Изменение задержек между сообщениями (ввод текстом «30-120»)
  - Валидация ввода (формат времени, диапазон задержек 5–600 сек)
...
### ~~Задача 6.3: Клавиатуры и состояния радара~~ ✅
...
### ~~Задача 6.4: Хендлер радара и регистрация роутера~~ ✅
